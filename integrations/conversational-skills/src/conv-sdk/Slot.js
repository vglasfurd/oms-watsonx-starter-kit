...
export class EntityValue {
     ...
     * @param {Array<string>} config.patterns - If the entity value is a regular expression
     */
    constructor({ label, value, synonyms, patterns = undefined }) {
        /**
...
export class Entity {
    ...
    static fromJson(jsonObject) {
        ...
        const entityValues = jsonObject.values.map(e => new EntityValue({ label: e.label, value: e.value, synonyms: e.synonyms, ...e }));
...
export class Slot {
     ...
     */
    constructor({ name, type, description, errorTemplate, prompt, value=undefined, event=undefined, schema=undefined, selectorFor=undefined, hidden = false }) {
        /**
    ...
    /**
     * Sets the type for the slot.
     * @param {SlotType} t The type of the slot
     */
    set type(t) {
        this._type = t;
    }
