import { SkillResponse } from './SkillResponse.js';
import { SkillState } from './SkillState.js';
import { SlotsInFlight } from './SlotsInFlight.js';
import { ConfirmationType } from './Constants.js';
    ...
    async orchestrate({ input, context, slots, state, confirmation_event = undefined }) {
        ...
        try {
            if (confirmation_event) {
                ...
                conversation_memory = get(context, 'global.session_history');
        ...
        return skillResponse instanceof SkillResponse ? skillResponse.toJson() : skillResponse;
    }
}
